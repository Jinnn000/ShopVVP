  ...
  if (isset($_POST['dangky'])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      if (
        ...
        if ($result) {
          echo '<div class="alert alert-success"> <strong>Đăng kí thành công !</strong> </div>';
        } else {
          echo '<div class="alert alert-danger"> <strong>Đăng kí thất bại !</strong> </div>';
        }

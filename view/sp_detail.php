      ...
      <div class="product-content">
        ...
        <div class="purchase-info">
          <form action="cart.php" method="post">
            <label for="slg">Số lượng </label>
            <input type="number" min="0" value="1" name="slg" id="slg">
            <input type="hidden" name="id" value="<?php echo $sanpham_id; ?>">
            <input type="hidden" name="name" value="<?php echo $sanpham_ten; ?>">
            <input type="hidden" name="anh" value="<?php echo $img2; ?>">
            <input type="hidden" name="price" value="<?php echo $sanpham_gia; ?>">
            <button type="submit" class="btn btn-success" name="addtocart" value="true">

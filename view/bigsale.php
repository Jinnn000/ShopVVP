        ...
        <?php 
            foreach ($listsp as $sanpham) {
                ...
                $img = "image/" . $sanpham_anh;
                  ...
                  $newprice= $sanpham_gia-($sanpham_gia*($khuyenmai/100));
                  $newformat= number_format($newprice,0,'.','.');
                ...
                <div id="product-1" class="single-product"  >
                        ...
                        <div class="part-2">
                                ...
                                <h4 class="product-old-price">'.$formated.' VND</h4>
                                <h4 class="product-price">'.$newformat.' VND</h4>
                        </div>
                </div>
        </div>';
            }

            ...
            if (isset($_POST['btn_themsp'])) {
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (isset($_POST['sp_id']) && isset($_POST['sp_ten']) && isset($_POST['sp_ncc']) && isset($_POST['sp_xx']) && isset($_POST['sp_m'])
                     && isset($_POST['sp_g']) && isset($_POST['sp_cl']) && isset($_FILES['sp_anh']) && isset($_POST['sp_nn'])) {
                        $dm_id = $_POST['dm_id'];
                        $sp_id = $_POST['sp_id'];
                        $sp_ten = $_POST['sp_ten'];
                        $sp_ncc = $_POST['sp_ncc'];
                        ...
                        if (isset($_FILES['sp_anh'])) {
                            ...
                            insert_sanpham($sp_id, $sp_ten, $sp_ncc, $sp_xx, $sp_m, $sp_cl, $sp_g, $sp_nn, $filename, $dm_id);
                        } else {
                ...
                case 'updatesp':
                        if (isset($_POST['btn_suasp'])) {
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                !empty($sp_g)){
                                    // Proceed with the update
                                    update_sanpham($dm_id,$sp_id,$sp_ten,$sp_ncc,$sp_xx,$sp_m,$sp_cl,$sp_g,$sp_nn,$sp_anh);
                                } else {
                                    echo "Vui lòng nhập đầy đủ thông tin!";
                                }
                            } else {
